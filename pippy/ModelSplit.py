...
"""
def _analyze_node_size(gm: pippy.fx.GraphModule) -> Dict[pippy.fx.Node, Dict[str, int]]:
...
"""
def split_on_size_threshold(mod : torch.nn.Module, threshold : int) -> Tuple[pippy.fx.GraphModule, int]:
