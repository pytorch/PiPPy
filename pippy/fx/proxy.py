...
class TracerBase:
    ...
    def iter(self, obj: "Proxy") -> Iterator:
        ...
        raise TraceError(
            ...
            "See the pippy.fx docs on pytorch.org for a "
...
class Proxy:
    ...
    def __len__(self):
        raise RuntimeError(
            ...
            "this call to be recorded, please call pippy.fx.wrap('len') at "
            "module scope"
        )
