...
NodeList = List[pippy.fx.Node]
NodeSet = Set[pippy.fx.Node]
Names = List[str]
...
class FxNetAccFusionsFinder:
    ...
    def __init__(self, module: pippy.fx.GraphModule, acc_nodes: NodeSet):
        self.module = module
    ...
    def __call__(self) -> Dict[pippy.fx.Node, NodeSet]:
        result: Dict[pippy.fx.Node, NodeSet] = {}
...
@compatibility(is_backward_compatible=False)
def legalize_graph(gm: pippy.fx.GraphModule):
    """
    ...
    value_remap: Dict[pippy.fx.Node, pippy.fx.Node] = {}
