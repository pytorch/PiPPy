...
class _MinimizerBase:
    ...
    def _store_outputs(
        ...
        submodule: pippy.fx.GraphModule,
    ):
        """
        ...
        # Only one output
        if isinstance(output_node.args[0], pippy.fx.Node):
    ...
    def _get_submod_inputs(
        self, main_module: pippy.fx.GraphModule, submod_path: str
    ...
    def _build_submodule(self, nodes: NodeSet) -> Tuple[pippy.fx.GraphModule, str]:
        ...
        Returns:
            split_module (pippy.fx.GraphModule): the module after split.
    ...
    def _run_and_compare(
        self, split_module: pippy.fx.GraphModule, submod_name: str, output_names: Names
    ):
        """
