...
class ScheduleInterleaved1F1B(PipelineScheduleMulti):
    def __init__(
        ...
        print(f"{self.rank=} {n_microbatches=} {self.n_local_stages=} {self.number_of_rounds=} {self.microbatches_per_round=}")
...
class ScheduleInterleaved1F1B_1(PipelineScheduleMulti):
    def __init__(
        self,
        stages: List[PipelineStageBase],
        n_microbatches: int,
