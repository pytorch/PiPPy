...
def parallelize_llama_MLP_block_2(model, num_layers, twod_mesh):
    # num_layer_per_rank = num_layers/pp_group_size
    # start_range = int(num_layer_per_rank*pp_rank)
    # end_range = int(num_layer_per_rank*(pp_rank+1))
    parallelize_plan={}
    for i in range(num_layers):
        parallelize_plan={
                        ...
                        f"model_layers_{i}.mlp.gate_proj":ColwiseParallel(),
                        f"model_layers_{i}.mlp.down_proj": RowwiseParallel(),
