...
from benchmark_utils import load_model, compile_model, display_memory_stats, display_model_size, benchmark_text_completion, prepare_prompts, write_to_csv, read_prompt_from_file
import logging
import fire
...
def main(model_args: str,
    ...
    if local_rank==0:
        ...
        metrics["max_gen_len"] = max_gen_len
        metrics["max_prompt_len"] = max_prompt_len
