...
class OpSchema(object):
    ...
    includes DTensor PlacementSpecs and non-tensor args/kwargs (positional order
    ...
    What can be changed:
        ...
        - every "PlacementSpec" attribute inside `args_schema`, `kwargs_schema` and
          `args_spec` SHOULD NOT be updated! PlacementSpec are read only and sharding
    ...
    @property
    def args_spec(self) -> Tuple[PlacementSpec, ...]:
        """
        args_spec: Tuple[PlacementSpec, ...]: contains a clean list of args spec list
        ...
        return tuple(
            item for item in self.args_schema if isinstance(item, PlacementSpec)
        )
...
class OutputSharding:
    ...
    exactly the same as the operator OpSchema, except the DTensor PlacementSpecs
    """
