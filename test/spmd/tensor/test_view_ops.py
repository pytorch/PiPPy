...
def dimmap_tests():
    ...
    dimmap_test(torch.atleast_3d, (randn(()), ), (SINGLETON, SINGLETON, SINGLETON))
    ...
    dimmap_test(torch.broadcast_to, (rand(24, 36), (1, 24, 36)), (SINGLETON, 0, 1))
    dimmap_test(torch.broadcast_to, (rand(24, 36), (42, 24, 36)), (BROADCAST(SINGLETON, 42), 0, 1))
    dimmap_test(torch.broadcast_to, (rand(24, 1, 36), (12, 24, 24, 36)), (BROADCAST(SINGLETON, 12), 0, BROADCAST(1, 24), 2))
    ...
    dimmap_test(torch.movedim, (randn(24, 6, 12), (0, 2, 1), (2, 1, 0)), (1, 2, 0))
